...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let embed = new MessageEmbed()
      ...
      .addField("Anti Nuke Settings", `${functions.text_block(`Channels Deleted Before Time: ${json["channels_deleted__time_before_quarantine"]}\nChannels Deleted Time: ${json["channels_deleted__time_before_quarantine"]}\n\nChannels Created Before Time: ${json["channels_created_time_before_quarantine"]}\nChannels Created Time: ${json["channels_created_time_before_quarantine"]}\n\nRoles Created Before Time: ${json["roles_created_time_before_quarantine"]}\nRoles Created Time: ${json["roles_created_time_before_quarantine"]}\n\nRoles Deleted Before Time: ${json["roles_deleted_time_before_quarantine"]}\nRoles Deleted Time: ${json["roles_deleted_time_before_quarantine"]}\n\nMembers Kicked Before Time: ${json["members_kicked_before_time_before_quarantine"]}\nMembers Kicked Time: ${json["members_kicked_before_time"]}\n\nMembers Banned Before Time: ${json["members_banned_before_time_before_quarantine"]}\nMembers Banned Time: ${json["members_banned_before_time"]}\n\nQuarantine/kick/ban On Dangerous Permissions Added: ${json["quarantine_on_dangerous_permissions_added"]}`)}`, true)
